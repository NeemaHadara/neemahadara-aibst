...
abline(v=median(x), col="red", lty="dashed")
abline(v=mean(x)-sd(x), col="blue")
abline(v=mean(x)+sd(x), col="blue", lty="dashed")
```
...
abline(v=mean(x)+2*sd(x), col="blue", lty="dashed")
abline(v=median(x)-mad(x), col="blue")
...
t <- pnorm(q=seq(-5,5,by=0.1))
plot(seq(-5,5,by=0.1), t)
